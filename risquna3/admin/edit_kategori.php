            ...
            <div id="content">
                ...
                <div class="container mb-7">
                    ...
                    if (isset($_GET['idkategori'])) {
                        ...
                        $select = mysqli_query($con, "SELECT * FROM kategori WHERE idkategori='$idkategori'") or die(mysqli_error($con));
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = mysqli_query($con, "UPDATE kategori SET kategori='$kategori'WHERE idkategori=' $idkategori'") or die(mysqli_error($con));
                 ...
                 <div class="container mb-8">
                        <div class="row">
                            <div class="col-md-5">
                                <form action="edit_kategori.php?idkategori=<?php echo $idkategori?>" method="post">
                                <div class="form-group">
                                        <label>Id Kategori</label>
                                        <input name="idkategori" type="text" class="form-control" readonly autofocus value="<?php echo $idkategori ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Kategori</label>
                                        <input name="kategori" type="text" class="form-control" required autofocus value="<?php echo $data['kategori'] ?>">
                                    </div>
