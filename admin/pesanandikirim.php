                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                <ul class="nav nav-tabs mb-5">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="pesanandikirim.php">Pesanan Dikirim</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="pesananselesai.php">Pesanan Selesai</a>
                                    </li>
                                    <table class="table mt-5 mb-5">
                                        ...
                                        <tbody>
                                            ...
                                            $tampil = mysqli_query($con, "SELECT * from cart WHERE status = 'SENDING PACKAGE'");
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-1"><a href="prosesdikirim.php?idcart=<?php echo $idcart ?>"><?= $kode ?></a></td>
