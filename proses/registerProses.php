<?php
    ...
    if(mysqli_num_rows($query) > 0){
        echo '<script>alert("Email sudah terdaftar");  document.location="../login.php";</script>';
    }else {
        ...
        $mail->Username = 'hairulb876@gmail.com';

        //Password to use for SMTP authentication
        $mail->Password = 'irul12345';

        //Set who the message is to be sent from
        $mail->setFrom('no-reply@yourwebsite.com', 'RR Store');
        ...
        if (!$mail->send()) {
            ...
            echo '<script>alert("Silahkan cek email untuk verifikasi akun"); document.location="../login.php";</script>';
            //Section 2: IMAP
