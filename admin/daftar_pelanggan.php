...
<body id="page-top">
    ...
    <div id="wrapper">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="col-1"><?php echo $alamat; ?></td>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            for ($i = 1; $i <= $jmlhalaman; $i++)
                                                if ($i != $halaman) {
                                                    echo " <li class='page-item'><a class='page-link' href='daftar_pelanggan.php?halaman=$i'> $i </a></li>";
                                                } else {
                                                    echo "<b>$i</b> | ";
                                                }
                                            ?>
        ...
        if (isset($_POST['tambah'])) {
            ...
            $alamat = $_POST['alamat'];
            $email = $_POST['email'];
            $sql = mysqli_query($con, "INSERT INTO users(nama,notelp,alamat,email)
                VALUES('" . $nama . "','" . $notelp. "','" . $alamat . "','" . $email . "')");
            if($sql){
                echo '<script>alert("Berhasil menambahkan data."); document.location="daftar_pelanggan.php";</script>';
            }else{
                echo '<script>alert("gagal menambahkan data."); document.location="daftar_pelanggan.php";</script>';
            }
        }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="daftar_pelanggan.php" method="post">
                            <div class="form-group">
                            <label>Nama</label>
                                <input name="nama" type="hidden" class="form-control" required>
                            </div>
                            <div class="form-group">
