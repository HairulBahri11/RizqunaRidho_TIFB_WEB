        ...
        <div class="col-12">
            <div class="background">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="pesanansaya.php">Belum Bayar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="pesanandiproses.php">Menunggu konfirmasi</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <tbody>
                        ...
                        $tampil = mysqli_query($con, "SELECT * from cart WHERE userid = '$sesID' AND status = 'WAITING CONFIRMATION' ");
